...
- Site source lives under `site/` and is built with Hugo. Treat `doc/*.1.md` as the source of truth for reference docs, then run `make docs` to regenerate and build the site docs.
...
2. Run `make docs` to sync generated site docs and verify the site builds cleanly.
